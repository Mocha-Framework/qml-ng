...
//
// For every @mocha-framework/qml-ng component, calls `ɵɵngDeclareComponent` to
...
import { EdgeSwipeGesture } from './components/EdgeSwipeGesture';
...

{
  const _def = ɵɵngDeclareComponent({
    ...
    styles: [],
    inputs: {
      edge: { classPropertyName: 'edge', publicName: 'edge', isSignal: true, isRequired: false, transformFunction: null },
      bandSize: { classPropertyName: 'bandSize', publicName: 'bandSize', isSignal: true, isRequired: false, transformFunction: null },
      threshold: { classPropertyName: 'threshold', publicName: 'threshold', isSignal: true, isRequired: false, transformFunction: null },
      hapticOnTrigger: { classPropertyName: 'hapticOnTrigger', publicName: 'hapticOnTrigger', isSignal: true, isRequired: false, transformFunction: null },
      enabled: { classPropertyName: 'enabled', publicName: 'enabled', isSignal: true, isRequired: false, transformFunction: null },
    },
    outputs: {
      edgeSwiped: 'edgeSwiped',
    },
  });
  (EdgeSwipeGesture as any)[ɵNG_COMP_DEF] = _def;
}
...

{
  const _def = ɵɵngDeclareComponent({
    ...
    inputs: {
      ...
      currentIndex: { classPropertyName: 'currentIndex', publicName: 'currentIndex', isSignal: true, isRequired: false, transformFunction: null },
      swipeToNavigate: { classPropertyName: 'swipeToNavigate', publicName: 'swipeToNavigate', isSignal: true, isRequired: false, transformFunction: null },
      pinchToZoom: { classPropertyName: 'pinchToZoom', publicName: 'pinchToZoom', isSignal: true, isRequired: false, transformFunction: null },
      maxZoom: { classPropertyName: 'maxZoom', publicName: 'maxZoom', isSignal: true, isRequired: false, transformFunction: null },
    },
    outputs: {
...

{
  const _def = ɵɵngDeclareComponent({
    ...
    styles: [],
    inputs: {
      condition: { classPropertyName: 'condition', publicName: 'condition', isSignal: true, isRequired: false, transformFunction: null },
      then: { classPropertyName: 'then', publicName: 'then', isSignal: true, isRequired: false, transformFunction: null },
      else: { classPropertyName: 'else', publicName: 'else', isSignal: true, isRequired: false, transformFunction: null },
      transition: { classPropertyName: 'transition', publicName: 'transition', isSignal: true, isRequired: false, transformFunction: null },
      duration: { classPropertyName: 'duration', publicName: 'duration', isSignal: true, isRequired: false, transformFunction: null },
    },
    outputs: {},
  });
  (If as any)[ɵNG_COMP_DEF] = _def;
}
...

{
  const _def = ɵɵngDeclareComponent({
    ...
    inputs: {
      duration: { classPropertyName: 'duration', publicName: 'duration', isSignal: true, isRequired: false, transformFunction: null },
      hapticOnTrigger: { classPropertyName: 'hapticOnTrigger', publicName: 'hapticOnTrigger', isSignal: true, isRequired: false, transformFunction: null },
      hapticStyle: { classPropertyName: 'hapticStyle', publicName: 'hapticStyle', isSignal: true, isRequired: false, transformFunction: null },
      pressed: { classPropertyName: 'pressed', publicName: 'pressed', isSignal: true, isRequired: false, transformFunction: null },
    },
    outputs: {
  ...
  (LongPressGesture as any)[ɵNG_COMP_DEF] = _def;
}
...

{
  const _def = ɵɵngDeclareComponent({
    ...
    styles: [],
    inputs: {
      minScale: { classPropertyName: 'minScale', publicName: 'minScale', isSignal: true, isRequired: false, transformFunction: null },
      maxScale: { classPropertyName: 'maxScale', publicName: 'maxScale', isSignal: true, isRequired: false, transformFunction: null },
      hapticOnBounds: { classPropertyName: 'hapticOnBounds', publicName: 'hapticOnBounds', isSignal: true, isRequired: false, transformFunction: null },
      respectReducedMotion: { classPropertyName: 'respectReducedMotion', publicName: 'respectReducedMotion', isSignal: true, isRequired: false, transformFunction: null },
      currentScale: { classPropertyName: 'currentScale', publicName: 'currentScale', isSignal: true, isRequired: false, transformFunction: null },
      baseScale: { classPropertyName: 'baseScale', publicName: 'baseScale', isSignal: true, isRequired: false, transformFunction: null },
    },
    outputs: {
      pinchStarted: 'pinchStarted',
      pinchUpdated: 'pinchUpdated',
      pinchFinished: 'pinchFinished',
    },
  });
  (PinchGesture as any)[ɵNG_COMP_DEF] = _def;
}
...

{
  const _def = ɵɵngDeclareComponent({
    ...
    styles: [],
    inputs: {
      target: { classPropertyName: 'target', publicName: 'target', isSignal: true, isRequired: false, transformFunction: null },
      threshold: { classPropertyName: 'threshold', publicName: 'threshold', isSignal: true, isRequired: false, transformFunction: null },
      hapticOnTrigger: { classPropertyName: 'hapticOnTrigger', publicName: 'hapticOnTrigger', isSignal: true, isRequired: false, transformFunction: null },
      enabled: { classPropertyName: 'enabled', publicName: 'enabled', isSignal: true, isRequired: false, transformFunction: null },
      refreshing: { classPropertyName: 'refreshing', publicName: 'refreshing', isSignal: true, isRequired: false, transformFunction: null },
    },
    outputs: {
      refresh: 'refresh',
  ...
  (PullToRefreshGesture as any)[ɵNG_COMP_DEF] = _def;
}
...

{
  const _def = ɵɵngDeclareComponent({
    ...
    styles: [],
    inputs: {
      enabledDirections: { classPropertyName: 'enabledDirections', publicName: 'enabledDirections', isSignal: true, isRequired: false, transformFunction: null },
      threshold: { classPropertyName: 'threshold', publicName: 'threshold', isSignal: true, isRequired: false, transformFunction: null },
      velocityThreshold: { classPropertyName: 'velocityThreshold', publicName: 'velocityThreshold', isSignal: true, isRequired: false, transformFunction: null },
      axis: { classPropertyName: 'axis', publicName: 'axis', isSignal: true, isRequired: false, transformFunction: null },
      enabled: { classPropertyName: 'enabled', publicName: 'enabled', isSignal: true, isRequired: false, transformFunction: null },
      consumeEvents: { classPropertyName: 'consumeEvents', publicName: 'consumeEvents', isSignal: true, isRequired: false, transformFunction: null },
      active: { classPropertyName: 'active', publicName: 'active', isSignal: true, isRequired: false, transformFunction: null },
      lastDirection: { classPropertyName: 'lastDirection', publicName: 'lastDirection', isSignal: true, isRequired: false, transformFunction: null },
      lastProgress: { classPropertyName: 'lastProgress', publicName: 'lastProgress', isSignal: true, isRequired: false, transformFunction: null },
    },
    outputs: {
      swiped: 'swiped',
      swipeProgress: 'swipeProgress',
      swipeCanceled: 'swipeCanceled',
    },
  });
  (SwipeGesture as any)[ɵNG_COMP_DEF] = _def;
}
