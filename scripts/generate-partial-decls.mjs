...
// for every component in @mocha-framework/qml-ng so JIT sees signal inputs.
...
lines.push(`//`);
lines.push(`// For every @mocha-framework/qml-ng component, calls \`ɵɵngDeclareComponent\` to`);
